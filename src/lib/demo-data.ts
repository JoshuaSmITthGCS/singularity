...
export const demoAssets: Asset[] = [
  {
    ...
    // Formula v2: medium (1000c) + 4.6 × 100c = 1460c
    price_cents: 1460,
    status: "published",
    complexity: "medium",
    quality_score: 4.6,
  ...
  },
  {
    ...
    // Formula v2: low (400c) + 4.2 × 100c = 820c
    price_cents: 820,
    status: "published",
    complexity: "low",
    quality_score: 4.2,
  ...
  },
  {
    ...
    // Formula v2: high (2000c), quality bonus pending verification
    price_cents: 2000,
    status: "verifying",
    complexity: "high",
    quality_score: null,
...
export const demoProcurements: Procurement[] = [
  {
    ...
    developer_share_cents: 1022,
    platform_fee_cents: 365,
    referral_reserve_cents: 73,
  ...
  },
  {
    ...
    developer_share_cents: 574,
    platform_fee_cents: 205,
    referral_reserve_cents: 41,
    pr_url: null,
    pr_number: null,
    status: "delivered",
    failure_reason: null,
...
function variant(
  ...
  return {
    ...
    status,
    model: status === "queued" ? null : "claude-sonnet-5",
    tokens_input: status === "queued" ? null : 18_400,
    tokens_output: status === "queued" ? null : 6_100,
    translation_cost_cents: status === "queued" ? null : 15,
